...
class RumahGadang extends ResourceController
{
    ...
    public function update($id = null)
    {
        ...
        $facilities = $request['facilities'];
        $updateFacilities = $this->detailFacilityRumahGadangModel->update_facility_api($facilities);
        $gallery = $request['gallery'];
    ...
    public function findByRating()
    {
        ...
        $list_rating = $this->visitHistoryModel->get_object_by_rating_api('rumah_gadang_id', $rating)->getResultArray();
