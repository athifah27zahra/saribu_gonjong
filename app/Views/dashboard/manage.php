                    ...
                    <table class="table table-hover dt-head-center" id="table-manage">
                        ...
                        <?php if (isset($data)): ?>
                            ...
                            <tr>
                                ...
                                <?php endif; ?>
                                <td>
                                    <a data-bs-toggle="tooltip" data-bs-placement="bottom" title="More Info" class="btn icon btn-outline-primary mx-1" href="<?= (isset($item['facility'])) ? base_url('dashboard/facilityRumahGadang/edit') . '/' . esc($item['id']) : current_url() .'/'. esc($item['id']); ?>">
