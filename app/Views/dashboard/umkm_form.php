    ...
    <div class="row">
        ...
        <div class="col-md-6 col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form form-vertical" action="<?= ($edit) ? base_url('dashboard/umkmPlace/update') . '/' . $data['id'] : base_url('dashboard/umkmPlace'); ?>" method="post" onsubmit="checkRequired(event)" enctype="multipart/form-data">
                        <div class="form-body">
                        <div class="form-group mb-4">
                            ...
                            <div class="form-group mb-4">
                                <label for="name" class="mb-2">UMKM Place Name</label>
                                <input type="text" id="name" class="form-control"
                                       name="name" placeholder="UMKM Place Name" value="<?= ($edit) ? $data['name'] : old('name'); ?>" required>
                            </div>
                            <div class="form-group mb-4">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="number" id="capacity" class="form-control"
                                       name="capacity" placeholder="Capacity" value="<?= ($edit) ? $data['capacity'] : old('capacity'); ?>">
                            </div>
                            <div class="form-group mb-4">
                ...
                <div class="card-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto mx-1">
                            <a data-bs-toggle="tooltip" data-bs-placement="bottom" title="Search" class="btn icon btn-outline-primary" onclick="findCoords('UP');">
...
<script>
    ...
    function checkRequired(event) {
        if (!$('#geo-json').val()) {
            ...
            Swal.fire('Please select location for the New UMKM Place');
        }
    }
</script>
<script>
