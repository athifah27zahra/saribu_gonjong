    ...
    <div class="row">
                ...
                <div class="card-body">
                    <form class="form form-vertical" action="<?= ($edit) ? base_url('dashboard/rumahGadang/update') . '/' . $data['id'] : base_url('dashboard/rumahGadang'); ?>" method="post" onsubmit="checkRequired(event)" enctype="multipart/form-data">
                        <div class="form-body">
                            ...
                            <div class="form-group mb-4">
                                <label for="ticket" class="mb-2">Ticket Price</label>
                                <div class="input-group">
                                    <span class="input-group-text">Rp </span>
                                    <input type="number" id="ticket" class="form-control"
                                           name="ticket" placeholder="Ticket Price" aria-label="Ticket Price" aria-describedby="ticket-price" value="<?= ($edit) ? $data['price'] : old('price'); ?>">
                                </div>
                            </div>
                            <div class="form-group mb-4">
        ...
        <div class="col-md-6 col-12">
            ...
            <div class="card">
                ...
                <script>initDrawingManager(<?= $edit==true?'true':'false'; ?>);</script>
            </div>
            <!-- Object Media -->
        </div>
    </div>
