    ...
    <div class="row">
        ...
        <div class="col-md-6 col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form form-vertical" action="<?= ($edit) ? base_url('dashboard/study/update') . '/' . $data['id'] : base_url('dashboard/study'); ?>" method="post" onsubmit="checkRequired(event)" enctype="multipart/form-data">
                        <div class="form-body">
                        <div class="form-group mb-4">
                            ...
                            <div class="form-group mb-4">
                                <label for="name" class="mb-2">Study Place Name</label>
                                <input type="text" id="name" class="form-control"
                                       name="name" placeholder="Study Place Name" value="<?= ($edit) ? $data['name'] : old('name'); ?>" required>
                            </div>
