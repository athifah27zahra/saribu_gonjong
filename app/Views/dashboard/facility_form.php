    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form form-vertical" action="<?= ($edit) ? base_url('dashboard/facilityRumahGadang/update') . '/' . $data['id'] : base_url('dashboard/facilityRumahGadang'); ?>" method="post" enctype="multipart/form-data">
                        <div class="form-body">
