    ...
    <div class="row">
        ...
        <div class="col-md-6 col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form form-vertical" action="<?= ($edit) ? base_url('dashboard/tourismObject/update') . '/' . $data['id'] : base_url('dashboard/tourismObject'); ?>" method="post" onsubmit="checkRequired(event)" enctype="multipart/form-data">
                        <div class="form-body">
                        <div class="form-group mb-4">
                            ...
                            <div class="form-group mb-4">
                                <label for="name" class="mb-2">Tourism Object Name</label>
                                <input type="text" id="name" class="form-control"
                                       name="name" placeholder="Tourism Object Name" value="<?= ($edit) ? $data['name'] : old('name'); ?>" required>
                            </div>
