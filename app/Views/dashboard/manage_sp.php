        ...
        <div class="card">
            <div class="card-header mb-4">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="card-title">Manage Service Package</h3>
                    </div>
                    ...
                    <table class="table table-hover dt-head-center" id="table-manage">
                        ...
                        <tbody class="text-center">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a data-bs-toggle="tooltip" data-bs-placement="bottom" title="More Info" class="btn icon btn-outline-primary mx-1" href="<?= (isset($dt['name'])) ? base_url('dashboard/facilityTourismPackage/edit') . '/' . esc($dt['id']) : current_url() .'/'. esc($dt['id']); ?>">
