                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" id="name" class="form-control"
                                       name="name" placeholder="Worship Place Name" value="<?= ($edit) ? $data['name'] : old('name'); ?>" required>
                            </div>
                            <div class="form-group mb-4">
                            ...
                            <div class="form-group mb-4">
                                <label for="building_size" class="mb-2">Building Size (m2)</label>
                                <input type="number" id="building_size" class="form-control"
                                       name="building_size" placeholder="Building Size" value="<?= ($edit) ? $data['building_size'] : old('building_size'); ?>">
                            </div>
                            <div class="form-group mb-4">
                ...
                <div class="card-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto mx-1">
                            <a data-bs-toggle="tooltip" data-bs-placement="bottom" title="Search" class="btn icon btn-outline-primary" onclick="findCoords('WP');">
