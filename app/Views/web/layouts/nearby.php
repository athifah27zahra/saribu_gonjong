        ...
        <div class="card-body">
            <div class="form-check">
                <div class="checkbox">
                    ...
                    <label for="check-sp">Souvenir</label>
                </div>
            </div>
            <div class="form-check">
                <div class="checkbox">
                    <input type="checkbox" id="check-wp" class="form-check-input">
                    <label for="check-wp">Worship</label>
                </div>
            </div>
            <div class="form-check">
                <div class="checkbox">
                    <input type="checkbox" id="check-cp" class="form-check-input">
                    <label for="check-cp">UMKM</label>
                </div>
            </div>
            <div class="form-check">
                <div class="checkbox">
                    <input type="checkbox" id="check-hp" class="form-check-input">
                    <label for="check-hp">History</label>
                </div>
            </div>
            <div class="mt-3">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive overflow-auto" id="table-result-nearby">
                ...
                <table class="table table-hover mb-md-5 mb-3 table-lg" id="table-hp">
                </table>
            </div>
        </div>
    </div>
