<div class="card">
    <div class="card-body">
        <div class="d-grid gap-2">
            ...
            if (!in_groups('admin')) {
                ?>
            <button class="btn-play btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#bookingModal">Booking Now</button>

            <div class="modal fade text-left" id="bookingModal" tabindex="-1" role="dialog" aria-labelledby="bookingModal" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
                    <div class="modal-content" style="padding:20px">
                        <h4>Are you sure want to order Tourism Package <?=$data['name']?>?</h4>
                        <a href="<?= base_url('booking/ubahpaket/'.$data['id']); ?>" class="btn btn-primary" style="margin-bottom:20px"</style>Custom Package</a>
                        <a href="<?= base_url('booking/keranjang/'.$data['id']); ?>" class="btn btn-primary">Yes</a>
